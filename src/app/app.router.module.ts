...
import {LogueoComponent} from "./page/logueo/logueo.component";
import {LoginComponent} from "./componentes/login/login.component";
import {RecuperaComponent} from "./page/recupera/recupera.component";
...
const routes: Routes = [{
  path:"",component:InitComponent,children :[
    ...
    {path:"Session",component:LogueoComponent},
    {path:"log",component:LoginComponent},
    {path:"Recuperar",component:RecuperaComponent},
